...
export default function Footer() {
  return (
   <>
     <footer className="md:mt-16 dark:bg-gray-800 dark:text-gray-50">
	<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
		<ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
			<li className='text-base font-semibold tracking-wide'> Home</li>
			<li  className='text-base font-semibold tracking-wide'>Sevices</li>
			<li className='text-base font-semibold tracking-wide'>Testimonials</li>
			<li className='text-base font-semibold tracking-wide'>Legal Blogs</li>
			<li className='text-base font-semibold tracking-wide'>Contact Us</li>
		</ul>
