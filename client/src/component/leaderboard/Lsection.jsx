...
export default function Lsection({data}) {
  // const data = 
  // [
  //   {
  //     "description": {
  ...
  //       "v": 0,
  //       "photo": "https://media.istockphoto.com/id/1398918059/photo/attractive-asian-lawyer-female-lawyer-discussing-contract-documents-with-golden-goddess.webp?b=1&s=170667a&w=0&k=20&c=d-DxVgj0zzqI4y9irSmKRmtFE0Grrtb1XceJ2wI_r7Y="
  //     },
  //     "uid": "2115000234",
  //     "phone_no": 9988776655,
...
const sortedData = sortByPointsSum(data);
  ...
  <div className='text-4xl m-2 tracking-wide  font-serif font-bold'>About Our Winners</div>
    ...
    <div className=" w-3/4 bg-white m-4 shadow-lg flex flex-col md:flex-row justify-center">
      <div className="mx-2">
        <img src={sortedData[0].ID.photo} alt="" className="rounded-full p-4 h-52 w-96" />
      </div>
      <div className="flex flex-col ml-5">
        <div className="font-bold text-lg text-gray-600 m-2 ">Recognizing the First Winner in Legal Innovation!</div>
        <div className="text-gray-500 m-2 text-sm">
        <div className='font-bold'>Name : {sortedData[0].ID.name}</div>
        <div className='font-bold my-1'>position : {sortedData[0].position}</div>
        <div className='font-bold my-1'>Rating : {sortedData[0].T_rating}</div>
          <p>
            Description It is with great pleasure that we recognize the third winner of the Legal Innovation Hackathon. Their outstanding efforts have made a significant impact on the accessibility of legal services in India.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col ">
        <div className="font-bold text-lg text-gray-600 m-2 ">Recognizing the Third Winner in Legal Innovation!</div>
        <div className="text-gray-500 m-2 text-sm">
        <div className='font-bold'>Name : {sortedData[1].ID.name}</div>
        <div className='font-bold my-1'>Position : {sortedData[1].position}</div>
        <div className='font-bold my-1'>Rating : {sortedData[1].T_rating}</div>
          <p>
            Description It is with great pleasure that we recognize the third winner of the Legal Innovation Hackathon. Their outstanding efforts have made a significant impact on the accessibility of legal services in India.
          </p>
        </div>
      ...
      <div className=" mx-2 ">
        <img src={sortedData[1].ID.photo} alt="" className="rounded-full p-4 h-52 w-96" />
      </div>
    </div>

    <div className=" w-3/4 bg-white m-4 shadow-lg flex flex-col md:flex-row justify-center">
      <div className="mx-2">
        <img src={sortedData[2].ID.photo} alt="" className="rounded-full p-4 h-52 w-96" />
      </div>
      <div className="flex flex-col ml-5">
        <div className="font-bold text-lg text-gray-600 m-2 ">Recognizing the Third Winner in Legal Innovation!</div>
        <div className="text-gray-500 m-2 text-sm">
        <div className='font-bold'>Name : {sortedData[2].ID.name}</div>
        <div className='font-bold my-1'>Position : {sortedData[2].position}</div>
        <div className='font-bold my-1'>Rating : {sortedData[2].T_rating}</div>
          <p>
            Description It is with great pleasure that we recognize the third winner of the Legal Innovation Hackathon. Their outstanding efforts have made a significant impact on the accessibility of legal services in India.
          </p>
        </div>
